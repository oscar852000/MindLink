...
Claude Code v2.1.3 后，Skill 和斜杠命令已合并：
- 用户可以用 `/skill-name` 手动调用
- 也会根据语义自动加载
- 统一存放在 `.claude/skills/` 目录
...
**更新记录**:
- v1.2: 新增锚点保护机制；更新 Skill 与斜杠命令说明（已合并）
